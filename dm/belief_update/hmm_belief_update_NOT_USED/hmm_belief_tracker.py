...
class HMMBeliefTracker(BeliefState):
    ...
    def __init__(self):
        super(HMMBeliefTracker, self).__init__()
        ...
        self._phi = DiscreteFactor(['DecisionState', 'Observation'], [3,3], self.slots['decision']*2, [0.5, 0.3, 0.2, 0.3, 0.5, 0.2, 0.25, 0.25, 0.5])#essmision parameter for P(x|z)
